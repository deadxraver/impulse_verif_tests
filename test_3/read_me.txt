...
4. Рассказать, что такое переменные make, окружения, компилятора (на данном примере)
 ...
 - Переменные окружения - передаем компилятору DDBG_PRINT=1, таким образом, при сборке теста он будет задефайнен, условие выполнится, а значит объявится макрос для дебаг принта
